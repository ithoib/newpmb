...
'<div id="c">';
	if($s_role==2){
		...
		'</div>'.
		'<p>Lengkapi biodata Anda di bawah ini dengan data yang sebenarnya.</p>';
		if($w=='tambah'){
			if($m=='ada'){
			...
			if($m=='ok'){
				echo '<div class="co">Perubahan data berhasil disimpan! <span class="cl"><i class="fas fa-times"></i></span></div>';
			}
		} elseif($w=='hapus'){
			if($m=='ok'){
		...
		'<form method="post" action="">'.
			'<div class="ch">'.
				...
				'<table>'.
					...
					'<tr>'.
						'<th>Nama Lengkap</th>'.
						'<td>:</td>'.
						'<td><input name="ubah[nama]" type="text" class="cht" value="'.$cama['nama'].'" aria-label="nama" required="" oninput="this.value = this.value.toUpperCase()"></td>'.
					'</tr>'.
					'<tr>'.
						'<th>NIK</th>'.
						'<td>:</td>'.
					...
					'<tr>'.
						...
						'<td>:</td>'.
						'<td>'.
							'<select name="ubah[prodi]" aria-label="prodi" required="" class="cht" '.($step>=5 ? 'disabled' : '').'>'.
							...
							echo '</select>'.
							($step>=5 ? '<input type="hidden" name="ubah[prodi]" value="'.$cama['prodi'].'">' : '').
						'</td>'.
					'</tr>'.
					'<tr>'.
						...
						'<td>:</td>'.
						'<td>'.
							'<select name="ubah[jalur]" aria-label="jalur" required="" class="cht" id="jalur" '.($step>=5 ? 'disabled' : '').'>'.
							...
							'</select>'.
							($step>=5 ? 
								'<input type="hidden" name="ubah[jalur]" value="'.$cama['jalur'].'">' : '').
						'</td>'.
					'</tr>'.
					'<tr>'.
						'<th>Jenis Kelamin</th>'.
					...
					'<tr>'.
						'<th>Tempat Lahir</th>'.
						'<td>:</td>'.
						'<td><input name="ubah[tempat_lahir]" type="text" class="cht" value="'.$cama['tempat_lahir'].'" aria-label="tempat_lahir" required="" oninput="this.value = this.value.toUpperCase()"></td>'.
					'</tr>'.
					'<tr>'.
						'<th>Tanggal Lahir</th>'.
						'<td>:</td>'.
					...
					'<tr>'.
						'<th>No. WA Aktif</th>'.
						'<td>:</td>'.
						'<td><input name="wa" type="text" class="cht" value="'.$cama['wa'].'" aria-label="wa" required="" disabled><input type="hidden" name="ubah[wa]" value="'.$cama['wa'].'" aria-label="wa aktif"></td>'.
					'</tr>'.
					'<tr>'.
						'<th>Email</th>'.
						'<td>:</td>'.
					...
					'<tr>'.
						'<th>Asal Sekolah</th>'.
						'<td>:</td>'.
						'<td><input name="ubah[asal_sekolah]" type="text" class="cht" value="'.$cama['asal_sekolah'].'" aria-label="asal_sekolah" required="" oninput="this.value = this.value.toUpperCase()"></td>'.
						// '<td>'.
						// 	'<div class="cal">'.
					...
					'<tr>'.
						'<th>Tahun Lulus</th>'.
						'<td>:</td>'.
						'<td><input name="ubah[thn_lulus]" type="number" class="chs" value="'.$cama['thn_lulus'].'" aria-label="thn_lulus" required=""></td>'.
					'</tr>'.
				'</table>'.
			'</div>'.
			'<div class="ch">'.
			...
			'<div class="ch">'.
				...
				'<table>'.
					'<tr>'.
						'<th>Nama Ayah</th>'.
						'<td>:</td>'.
						'<td><input name="ubah[nama_ayah]" type="text" class="cht" value="'.$cama['nama_ayah'].'" aria-label="nama_ayah" required="" oninput="this.value = this.value.toUpperCase()"></td>'.
					'</tr>'.
					'<tr>'.
						'<th>NIK Ayah</th>'.
						'<td>:</td>'.
				...
				'<table>'.
					'<tr>'.
						'<th>Nama Ibu</th>'.
						'<td>:</td>'.
						'<td><input name="ubah[nama_ibu]" type="text" class="cht" value="'.$cama['nama_ibu'].'" aria-label="nama_ibu" required="" oninput="this.value = this.value.toUpperCase()"></td>'.
					'</tr>'.
					'<tr>'.
						'<th>NIK Ibu</th>'.
						'<td>:</td>'.
				...
				'<table>'.
					'<tr>'.
						'<th>Nama Wali</th>'.
						'<td>:</td>'.
						'<td><input name="ubah[nama_wali]" type="text" class="cht" value="'.$cama['nama_wali'].'" aria-label="nama_wali" oninput="this.value = this.value.toUpperCase()"></td>'.
					'</tr>'.
					'<tr>'.
			...
			'<div class="ch" id="kip" '.($cama['jalur']=='KIP' ? '' : 'style="display:none"').'>'.
				...
				'<p>Isi form di bawah ini jika Anda mengambil jalur <strong>KIP</strong> dan sudah memiliki akun <strong>KIP</strong>. Biarkan kosong jika belum memiliki akun <strong>KIP</strong>.</p>'.
				'<table>'.
					'<tr>'.
